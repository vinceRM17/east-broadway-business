        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-primary-foreground font-bold text-xs tracking-tight leading-none">
                <span className="flex flex-col items-center"><span className="text-[8px] font-light tracking-[0.12em]">EAST</span><span className="text-[9px] font-bold -mt-0.5">BWAY</span></span>
              </div>
